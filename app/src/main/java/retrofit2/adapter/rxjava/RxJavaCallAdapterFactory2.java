...
public final class RxJavaCallAdapterFactory2 extends CallAdapter.Factory {
  ...
  public static RxJavaCallAdapterFactory2 createWithScheduler(@Nonnull Scheduler SchedulerOn , @Nonnull Scheduler ObservableOn) {
    if (SchedulerOn == null) throw new NullPointerException("scheduler == null");
    if (ObservableOn == null) throw new NullPointerException("scheduler == null");
    return new RxJavaCallAdapterFactory2(SchedulerOn, ObservableOn,false);
  }

  private final @Nullable Scheduler scheduler;
  private final @Nullable Scheduler observable;
  private final boolean isAsync;

  private RxJavaCallAdapterFactory2(@Nullable Scheduler schedulerOn,@Nullable Scheduler ObservableOn ,boolean isAsync) {
    this.scheduler = schedulerOn;
    this.observable = ObservableOn;
