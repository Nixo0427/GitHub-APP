...
public final class RxJavaCallAdapterFactory2 extends CallAdapter.Factory {
  ...
  public static RxJavaCallAdapterFactory2 createWithScheduler(Scheduler subScurableOn , Scheduler obServableOn) {
    if (subScurableOn == null) throw new NullPointerException("scheduler == null");
    if (obServableOn == null) throw new NullPointerException("obServableOn == null");
    return new RxJavaCallAdapterFactory2(subScurableOn, obServableOn,false);
  }
  ...
  private RxJavaCallAdapterFactory2(@Nullable Scheduler scheduler,Scheduler obServableOn,boolean isAsync) {
  ...
  public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
    ...
    if (isCompletable) {
      return new RxJavaCallAdapter2(Void.class, scheduler, obServableOn, isAsync, false, true, false, true);
    }
    ...
    return new RxJavaCallAdapter2(responseType, scheduler,obServableOn, isAsync, isResult, isBody, isSingle,
        false);
  }
}
