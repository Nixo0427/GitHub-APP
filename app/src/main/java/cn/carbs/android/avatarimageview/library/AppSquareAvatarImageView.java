...
import static cn.carbs.android.avatarimageview.library.AppCompatAvatarImageView.COLORS;
 ...
 *
 */
public class AppSquareAvatarImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public AppSquareAvatarImageView(Context context) {
        super(context);
        init();
    }
    public AppSquareAvatarImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttr(context, attrs);
        init();
    }
    public AppSquareAvatarImageView(Context context, AttributeSet attrs, int defStyleAttr) {
